    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                .authorizeHttpRequests(auth -> auth
                        ...
                        // PAYMENT ENDPOINTS - MUST be before role-specific patterns
                        // Allow PATIENT to access their own payment endpoints
                        //.requestMatchers("/payment/create/**", "/payment/process", "/payment/receipt/**").hasAnyRole("PATIENT", "ADMIN", "SUPER_ADMIN")

                        // CRITICAL: Payment endpoints - Allow authenticated users
                        .requestMatchers("/payment/create/**")
                        .hasRole("PATIENT")

                        .requestMatchers("/payment/process")
                        .hasRole("PATIENT")

                        .requestMatchers("/payment/receipt/**")
